...
namespace Network.Presentation.Models
{
    public class BaseModels
    {
        ...
        public IEnumerable<SelectListItem> DdlUfListaID { get; set; }
        public IEnumerable<SelectListItem> DdlPerfilListaLoja { get; set; }
        public IEnumerable<SelectListItem> DdlPerfilListaSegmentoLoja { get; set; }
        public IEnumerable<SelectListItem> DdlPerfilListaAll { get; set; }
    }
}